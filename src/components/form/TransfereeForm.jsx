...
const TransfereeForm = () => {
    ...
    const clearInputFile4 = useRef(null);
    ...
    const { fileOne, fileTwo, fileThree, fileFour } = inputFile;
    ...
    const handleChange = (e) => {
        ...
        if ((name === 'phone' || name === 'parentPhone') && (isNaN(value) || value < 0)) {
            Swal.fire({
                icon: 'error',
                title: 'Invalid Phone Number',
                text: 'Phone number should be a positive number.',
                confirmButtonColor: '#22C55E',
            });
            return;
        }
        ...
        if (name === 'zipCode' && (isNaN(value) || value.length > 5)) {
            Swal.fire({
                ...
                text: 'Zip Code should be a numeric value with a maximum of 5 digits.',
                confirmButtonColor: '#22C55E',
            });
            return;
        }
        ...
        } else if((e.target.name === 'phone' || e.target.name === 'parentPhone') && e.target.value.length > 10) {
            Swal.fire({
                icon: 'error',
                title: 'Invalid Phone Number',
                text: 'Phone number should be exactly 10 digits.',
        ...
        } else if (e.target.name === 'lrn' && e.target.value.length > 13) {
            Swal.fire({
                icon: 'error',
                title: 'Invalid LRN',
    ...
    const handleSubmit = async (e) => {
        ...
        if (school.trim() === '') {
            Swal.fire({
                icon: 'error',
                title: 'Empty Previous School Name',
                text: 'Please Enter your Previous School Name.',
                confirmButtonColor: '#22C55E',
            });
            setIsSubmitting(false);
            return;
        ...
        if(fileFour) {
            formData.append('files', fileFour);
        }
        ...
        formData.append('studentStatus', 'Transferee');
        ...
        try {
            ...
            if (clearInputFile4.current) {
                clearInputFile4.current.value = '';
            }
            setIsSubmitting(false);
            fetchSchedules();
        } catch(e){
    ...
    <div className='w-full min-h-screen bg-gradient-to-r from-green-400 to-green-600'>
        ...
        <div className='p-5 w-full shadow-lg'>
            <form ref={form} onSubmit={handleSubmit} className='bg-white max-w-5xl p-12 shadow rounded-lg mt-16 mx-auto max-sm:px-5'>
                <h2 className='text-3xl uppercase font-bold mb-5 text-black max-sm:text-xl'>APPLICATION FORM FOR TRANSFEREES</h2>    
                ...
                <div className='flex items-center justify-center gap-[30px] mb-8 max-sm:flex-col'>
                    <div className="w-1/2 max-sm:w-full">
                        ...
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='lastName' value={lastName} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>First Name*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='type here' name='firstName' value={firstName} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Middle Name</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='type here' name='middleName' value={middleName} onChange={handleChange}/>
                    </div>

                    <div className="w-1/4 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none capitalize'>Suffix</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='opt.' name='extensionName' value={extensionName} onChange={handleChange}/>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-center gap-[30px] mb-8 max-sm:flex-col'>
                    <div className="w-1/4 max-sm:w-full">
                        ...
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="number" placeholder='...' name='age' value={age} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Gender*</span>
                        <select name="sex" onChange={handleChange} className='w-full p-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' required>
                    ...
                    <div className="w-1/2 max-sm:w-full">
                        ...
                        <select name="civilStatus" onChange={handleChange} className='w-full p-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' required>
                    ...
                    <div className="w-1/2 max-sm:w-full">
                        ...
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='religion' value={religion} onChange={handleChange}/>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-center gap-[30px] mb-8 max-sm:flex-col'>
                    <div className="w-1/2 max-sm:w-full">
                        ...
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none capitalize' type="date" placeholder='Date of Birth' name='dob' value={dob} onChange={handleChange} />
                    </div>

                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Place of Birth*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='type here' name='placeOfBirth' value={placeOfBirth} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Permanent Address*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='address' value={address} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/3 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Citizenship*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='citizenship' value={citizenship} onChange={handleChange} required/>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-center gap-[30px] mb-12 max-sm:flex-col'>
                    <div className="w-1/2 max-sm:w-full">
                        ...
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='lrn' value={lrn} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Email Address*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="email" placeholder='Type here' name='email' value={email} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/3 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Phone Number*<span className='text-gray-700'> +63</span></span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="number" placeholder='Phone (9xxxxxxxxx)' name='phone' value={phone} onChange={handleChange} maxLength={10} required/>
                    </div>

                    <div className="w-1/4 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Zip Code*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='zipCode' value={zipCode} onChange={handleChange} required/>
                    </div>        
                </div>
                ...
                <div className='flex items-center justify-center gap-[30px] mb-12 max-sm:flex-col'>
                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Parent Name*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='parentName' value={parentName} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/2 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Occupation*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Type here' name='occupation' value={occupation} onChange={handleChange} required/>
                    </div>

                    <div className="w-1/3 max-sm:w-full">
                        <span className='label-text text-black font-bold select-none'>Phone Number*<span className='text-gray-700'> +63</span></span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="number" placeholder='Phone (9xxxxxxxxx)' name='parentPhone' value={parentPhone} onChange={handleChange} maxLength={10} required/>
                    </div>
                </div>
                ...
                <div className="flex items-start justify-center mb-12 max-sm:flex-col">
                    <div className="w-1/2 max-sm:w-full">
                        <h2 className='text-2xl font-bold text-black break-all text-center max-sm:text-lg'>FOR TRANSFEREES</h2>
                        <p className='mt-6 text-base font-normal text-center max-sm:text-xs'>Previous School Name</p>
                        <span className='label-text text-black font-bold select-none mt-3'>*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Input N/A or leave it blank if you are not.' name='school' value={school} onChange={handleChange}/>


                        <p className='mt-6 text-base font-normal text-center max-sm:text-xs'>Address of School</p>
                        <span className='label-text text-black font-bold select-none mt-3'>*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Input N/A or leave it blank if you are not.' name='schoolAddress' value={schoolAddress} onChange={handleChange}/>


                        <p className='mt-6 text-base font-normal text-center max-sm:text-xs'>Grade Level</p>
                        <span className='label-text text-black font-bold select-none mt-3'>*</span>
                        <input className='w-full p-4 pr-4 text-sm text-black bg-[#EBEBEB] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Input N/A or leave it blank if you are not.' name='course' value={course} onChange={handleChange}/>
                    </div>
                </div>
                ...
                <div className='flex items-start justify-center gap-[30px] mb-20 mt-8 max-sm:flex-col'>
                    <div className="w-1/2 max-sm:w-full">
                        <p className='text-lg font-medium text-black max-sm:text-base'>Upload a Copy of Transcript Record.</p>
                        ...
                        <p className='text-lg font-medium text-black max-sm:text-base mt-5'>Upload a Copy of PSA Birth Certificate.</p>
                        <p className='label-text text-justify mt-2 max-sm:text-xs'>Note: Documents should be readable and completely scanned</p>
                        ...
                        <p className='text-lg font-medium text-black max-sm:text-base mt-5'>Upload a Copy of Certificate of Grade.</p>
                        <p className='label-text text-justify mt-2 max-sm:text-xs'>Note: Documents should be readable and completely scanned</p>
                        ...
                        <p className='label-text text-justify mt-5 max-sm:text-xs'>2 pieces Identical Photograph, Passport size with name tag, white background, and taken within the last six months.</p>
                        <input ref={clearInputFile4} className='file-input file-input-bordered file-input-sm w-full max-w-xs rounded-md mt-2' type="file" name='fileFour' onChange={handleFileChange} accept='.pdf' required/>
                    </div>
                </div>
